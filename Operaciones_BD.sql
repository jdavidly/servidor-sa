...
BEGIN
    ...
    IF user_ = -1 THEN
		INSERT INTO Usuario(Nombre, Apellido, Empresa, Email, Contrasena, Celular, Direccion, Tipo_Usuario)
        VALUE (_Nombre,_Apellido, _Empresa, _Email,_Contrasena,_Celular, _Direccion, _Tipo_Usuario);
		RETURN (1);
	ELSE
		RETURN (-1);
    END IF;
